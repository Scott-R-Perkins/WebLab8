...
{
    /// <inheritdoc />
    public partial class newMigrationFixes2 : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 4, 290.0, 0.75, 50, 37.5, "Staff imbued with a medium amount of arcane power, ideal for students studying the magical arts", "Y5tHLvN", "Arcane apprentice staff", 700 },
                    { 5, 600.0, 0.5, 70, 35.0, "Staff imbued with a large amount of destructive fire magic, dangerous in the hands of an unskilled wizard, deadly in the hands of a skilled one.", "mQbqS1A", "Staff of destructive oblivion", 2900 }
                });
        }
    }
}
